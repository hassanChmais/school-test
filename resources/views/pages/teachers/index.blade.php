...
@section('content')
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('add_teacher')}}" class="btn btn-success btn-sm" role="button"
    ...
    <div class="table-responsive">
              ...
              @foreach($teachers as $Teacher)
                        <tr>
                         ...
                         <td>{{$Teacher->name_teacher}}</td>
                           ...
                           <td>{{$Teacher->specializations->name_special}}</td>
        <td><a href="{{route('editTeacher',$Teacher->id)}}" class="btn btn-info btn-sm" role="button" aria-pressed="true"><i class="fa fa-edit"></i></a>
        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete_Teacher{{ $Teacher->id }}" title="{{ trans('Grades_trans.Delete') }}"><i class="fa fa-trash"></i></button>
         ...
         <form action="{{route('deleteTeacher',$Teacher->id)}}" method="GET">
          @csrf
         ...
         <div class="modal-body">
          ...
          <input type="hidden" name="id"  value="{{$Teacher->id}}"></div>
