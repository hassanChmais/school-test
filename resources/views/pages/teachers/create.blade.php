                                ...
                                <div class="form-group col">
                                    ...
                                    <select class="custom-select my-1 mr-sm-2" name="special_id" required>
                                        ...
                                        @foreach($specializations as $specialization)
                                            <option value="{{$specialization->id}}">{{$specialization->name_special}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class='input-group date'>
                                        <input class="form-control" type="text"  id="datepicker-action" name="date" data-date-format="yyyy-mm-dd" value="{{old('date')}}" >
                                    </div>
                                </div>
                            </div>
                            <br>
