                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        ...
                        <ul id="elements" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{ route('grades') }}">{{trans('main_trans.Grades_List')}}</a></li>
                        </ul>
                    </li>
                    <!-- menu item calendar-->
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#calendar-menu">
                            <div class="pull-left"><i class="ti-calendar"></i><span
                                    class="right-nav-text">{{trans('main_trans.Class')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="calendar-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route('classes') }}">{{trans('main_trans.Class_List')}}</a> </li>
                        </ul>
                    </li>
                    <!-- menu item todo-->
                    <li>
                        ...
                        <ul id="calendar-menu1" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route('sections') }}">{{trans('main_trans.Section_List')}}</a> </li>
                        </ul>
                    </li>
                                        <li>
                    ...
                    <ul id="calendar-menu2" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route('parents') }}">{{trans('main_trans.Parents')}}</a> </li>
                        </ul>
                    </li>
                                                            <li>
                    ...
                    <ul id="calendar-menu3" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route('teachers') }}">{{trans('main_trans.Teachers_list')}}</a> </li>
                        </ul>
                    </li>
                    <!-- menu item chat-->
                    <li>
